...
const app=v.application||{}, how=v.how_it_works||{}, origin=v.origin||{}, src=(Array.isArray(v.sources)?(v.sources[0]||{}):(v.sources||{}));
 ...
 <div class=pcv2-panel><div id=v2_variants class=pcv2-list>${(v.variants||[]).map(rowVariant).join('')}</div><button class=pcv2-add data-add=variant type=button>+ Додати SKU</button></div>
