...
function ensureStyle(){if(document.querySelector('link[data-bbop-autumn]'))return;const l=document.createElement('link');l.rel='stylesheet';l.href='assets/css/home-organic-autumn.css?v=20260922b';l.dataset.bbopAutumn='1';document.head.appendChild(l)}
...
function buildHero(){const sec=document.createElement('section');sec.className='bb22-hero';sec.innerHTML=`
...
<div class="bb22-hero-copy"><div class="bb22-hero-kicker">BB610 MARKET</div><h1>Професійні товари<br><span>для вирощування</span></h1><p>Добрива, біостимулятори та професійні рішення для живлення рослин</p><a class="bb22-hero-btn" href="catalog.html">Перейти до каталогу →</a></div>`;return sec}
...
<div class="bbop-head"><div><div class="bbop-kicker">Сезонний вибір · вересень–жовтень</div><h2>Актуально восени</h2></div><p>Добірки за поточною потребою. Інформацію щодо застосування звіряйте з рекомендаціями виробника.</p></div>
<div class="bbop-scenarios">
<a id="bbop-winter" class="bbop-scenario bbop-winter" href="catalog.html?category=nutrition"><img loading="lazy" src="assets/culture/photos/blueberry.jpg" alt="Багаторічні культури восени"><div class="bbop-scenario-copy"><div class="bbop-kicker">Лохина · малина · сад · декоративні</div><h3>Підготовка багаторічних рослин до зими</h3><p>Сезонна добірка продуктів для завершення вегетації та осінніх програм живлення.</p><span class="bbop-scenario-link">Переглянути добірку →</span></div></a>
<a id="bbop-planting" class="bbop-scenario bbop-planting" href="catalog.html?category=biostimulation"><img loading="lazy" src="assets/culture/photos/orchard.jpg" alt="Осіння посадка та пересадка"><div class="bbop-scenario-copy"><div class="bbop-kicker">Посадка · пересадка</div><h3>Осіння посадка та укорінення</h3><p>Товари для кореневої системи та підтримки рослин після пересадки — за даними виробника.</p><span class="bbop-scenario-link">Переглянути добірку →</span></div></a>
</div>
<div class="bbop-note">BB610 структурує асортимент за сезонною потребою, але не призначає індивідуальну схему живлення.</div>`;return sec}
function patchSeasonal(){document.querySelectorAll('.bbop-seasonal').forEach(x=>x.remove());const hero=document.querySelector('.bb22-hero');hero?.insertAdjacentElement('afterend',buildSeasonal())}
...
function apply(){ensureStyle();patchNav();patchHero();patchSeasonal();patchDirections();patchCultures();cleanupLegacy();document.documentElement.dataset.bb610Homepage='22b-autumn-banners'}
