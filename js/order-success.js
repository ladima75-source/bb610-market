document.addEventListener('DOMContentLoaded',async()=>{
  ...
  try{
    ...
    root.innerHTML=`<div class="order-state success"><div class="eyebrow">ЗАМОВЛЕННЯ ПРИЙНЯТО</div><h1>Дякуємо</h1><p>Номер замовлення: <b>${o.order_number||o.order_id}</b></p><p>${o.customer_message||'Ми отримали замовлення та зв’яжемося з вами щодо підтвердження.'}</p><a class="btn" href="../../index.html">ПОВЕРНУТИСЯ ДО МАГАЗИНУ</a></div>`;
