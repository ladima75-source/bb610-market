...
def main():
    ...
    for item in batch:
        ...
        m=card.setdefault("import_meta",{}); m["stage22c_batch"]="06"; m["stage22c_content_date"]="2026-09-05"
    ...
    if q.apply:
        ...
        out=r/"var/import-reports"; out.mkdir(parents=True,exist_ok=True); (out/"stage22c_batch06_latest.json").write_text(json.dumps(rep,ensure_ascii=False,indent=2),encoding="utf-8")
